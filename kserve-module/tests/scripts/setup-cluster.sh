...
Environment variables:
  ...
  LOCALMODEL_CONTROLLER_IMAGE, LOCALMODELNODE_AGENT_IMAGE
...
deploy_kserve_module() {
  ...
  [[ -n "${LOCALMODEL_CONTROLLER_IMAGE:-}" ]] && \
    _env_overrides+=("RELATED_IMAGE_ODH_KSERVE_LOCALMODEL_CONTROLLER_IMAGE=${LOCALMODEL_CONTROLLER_IMAGE}")
  [[ -n "${LOCALMODELNODE_AGENT_IMAGE:-}" ]] && \
