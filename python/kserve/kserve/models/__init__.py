...
from kserve.models.v1alpha1_local_model_namespace_cache_list import V1alpha1LocalModelNamespaceCacheList
...
from kserve.models.v1beta1_storage_uri import V1beta1StorageUri
