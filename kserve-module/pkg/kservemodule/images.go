...
var kserveImageParamMap = map[string]string{
	...
	"kserve-llm-d-cpu":                                 "RELATED_IMAGE_RHAII_VLLM_CPU_IMAGE",
	"kserve-llm-d-cpu-fast-1":                          "RELATED_IMAGE_RHAII_VLLM_CPU_FAST_1_IMAGE",
	"kserve-llm-d-cpu-fast-2":                          "RELATED_IMAGE_RHAII_VLLM_CPU_FAST_2_IMAGE",
	"kserve-llm-d-cpu-upstream-version":                "RELATED_IMAGE_RHAII_VLLM_CPU_IMAGE_UPSTREAM_VERSION",
	"kserve-llm-d-cpu-fast-1-upstream-version":         "RELATED_IMAGE_RHAII_VLLM_CPU_FAST_1_IMAGE_UPSTREAM_VERSION",
	"kserve-llm-d-cpu-fast-2-upstream-version":         "RELATED_IMAGE_RHAII_VLLM_CPU_FAST_2_IMAGE_UPSTREAM_VERSION",
