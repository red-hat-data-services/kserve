...
RUN microdnf install -y --disablerepo=* --enablerepo=ubi-8-baseos-rpms python39 python39-devel gcc libffi-devel openssl-devel krb5-workstation krb5-libs && microdnf clean all
